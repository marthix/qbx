...
<html>
	...
	<head>
		...
		<title>Portfolio - The Quarterback Exchange</title>
		...
		<div class="wrapper">
			...
			<div class="content-wrapper">
				...
				<section class="content">
					...
					<!--#include virtual="/build/asp/widgets/portfolioWidgets.asp"-->
					
					<div class="row">
					
						<div class="col-lg-12">
							<!--#include virtual="/build/asp/widgets/listHoldings.asp"-->
						</div>
					...
					<div class="row">
						...
						<div class="col-lg-8">
							<!--#include virtual="/build/asp/widgets/listTransactions.asp"-->
						</div>
					
						<div class="col-lg-4">
							<!--#include virtual="/build/asp/widgets/portfolioHistory.asp"-->
						</div>
