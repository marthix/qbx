...
<%
	...
	If throwError = 0 Then
		...
		If Not rsExistingHoldings.Eof Then
			...
			rsExistingHoldings.Close
			Set rsExistingHoldings = Nothing
			sqlUpdateHoldings = "UPDATE qbx_holdings SET share_Total = 0, cash_Value = 0.00 WHERE portfolio_ID = " & portfolio_ID & " AND user_ID = " & user_ID & " AND qb_ID = " & qb_ID
		...
		Else
			...
			rsInsert("user_ID") = user_ID
			rsInsert("qb_ID") = qb_ID
			rsInsert("share_Total") = 0
			rsInsert("cash_Value") = 0.00
			rsInsert.Update
			Set rsInsert = Nothing
...
%>
	<div class="row">
		<div class="col-md-12" align="center">
			...
			<h3 style="padding-top: 0px; margin-top: 0px; margin-bottom: 14px;">0</h3>
