<div class="box box-warning">
	...
	<div class="box-header with-border">
		...
		<h3 class="box-title">Trending Down</h3>
...
<%
				...
				Do While Not rsQuarterbacks.Eof 
					...
					Response.Write("<tr>")
						...
						Response.Write("<td><span class=""text-red"">" & FormatNumber(rsQuarterbacks("price_Change"), 0) & "%</span></td>")
					Response.Write("</tr>")
