<%
	sqlGetPortfolio = "SELECT portfolio_ID, cash_Value, share_Value, cash_Value + share_Value AS net_Worth FROM samelevel.qbx_portfolios WHERE samelevel.qbx_portfolios.is_Current = 1 AND samelevel.qbx_portfolios.user_ID =  " & Session.Contents("QBX_ID") & " ORDER BY date_Calculated DESC LIMIT 1"
	...
	sqlGetPreviousNetWorth = "SELECT ROUND(cash_Value + share_Value, 2) AS NetWorth FROM samelevel.qbx_portfolios WHERE user_ID = " & Session.Contents("QBX_ID") & " AND is_Current = 0 ORDER BY date_Calculated desc LIMIT 1"
	...
	<div class="row">
		...
		<div class="col-md-3 col-sm-12 col-xs-12">
			...
			<div class="info-box bg-blue">
				...
				<span class="info-box-icon"><img src="/build/img/users/<%= Session.Contents("QBX_Avatar") %>" align="center" width="75%" class="img-circle" style="margin-top: -10px; padding-top: 0; border: 1px solid #fff;" /></span>
				<div class="info-box-content">
					<span class="info-box-text"><%= Session.Contents("QBX_Name") %></span>
		...
		<div class="col-md-3 col-sm-12 col-xs-12">
			...
			<div class="info-box bg-purple">
				...
				<div class="info-box-content">
					...
					<span class="progress-description"><%= change_NetWorth %>% Weekly Increase</span>
				</div>
