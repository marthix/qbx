<div class="box box-warning">
	...
	<div class="box-body">
		...
		<table id="listTransactions" class="table table-bordered table-striped display responsive nowrap" width="100%" cellpadding="0">
			<thead>
				<tr>
					<th>Quarterback</th>
					<th>Date</th>
