...
<html>
	...
	<head>
		...
		<title>Quarterbacks - The Quarterback Exchange</title>
	...
	<body class="sidebar-mini skin-green">
			...
			<div class="content-wrapper">
				...
				<section class="content">
					...
					<div class="row">
						...
						<div class="col-lg-8">
							<!--#include virtual="/build/asp/widgets/listQuarterbacks.asp"-->
						</div>
						
						<div class="col-lg-4">
						
							<!--#include virtual="/build/asp/widgets/listTrendingUp.asp"-->
							
							<!--#include virtual="/build/asp/widgets/listTrendingDown.asp"-->
		...
		<script src="/build/js/quarterbacks.js" type="text/javascript"></script>		
