...
<%
	thisPage = "Transactions"
%>
<html>
	
	<head>
		
		<title>Transactions - The Quarterback Exchange</title>
	...
	<body class="sidebar-mini skin-green">
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					...
					<ol class="breadcrumb">
						...
						<li class="active"><a href="/leaderboard/"><i class="fa fa-retweet"></i> Transactions</a></li>
					</ol>
				</section>
				...
				<section class="content">
					...
					<div class="row">
						...
						<div class="col-lg-12">
							<!--#include virtual="/build/asp/widgets/listAllTransactions.asp"-->
						</div>
		...
		<script src="/build/js/transactions.js" type="text/javascript"></script>
